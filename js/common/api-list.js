(function (win, dependencies) {
  ...
  var disconnect = {
    ...
    desc: '断开链接',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/connection/disconnect/web',
    params: []
  };
  ...
  var reconnect = {
    ...
    eventName: 'reconnect',
    desc: '重新链接',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/connection/reconnect/web',
    params: [
  ...
  var registerMessage = {
    ...
    desc: '注册自定义消息',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgsend/web#register',
    params: [
  ...
  var getConversationList = {
    ...
    desc: '获取会话列表',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/getall/web#remote',
    params: [
  ...
  var removeConversation = {
    ...
    desc: '删除会话列表',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/clear/web',
    params: [
  ...
  var getConversation = {
    ...
    desc: '获取会话列表',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/get/web',
    params: [
      { name: '会话类型', type: 'number', value: 1 },
      { name: '对方 id', type: 'string', value: config.targetId },
      { name: 'channelId', type: 'string', value: '' }
  ...
  var getRemoteHistoryMessages = {
    ...
    desc: '获取远端历史消息',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/storage/web#getHistory',
    params: [
      { name: '会话类型', type: 'number', value: 1 },
      { name: '对方 id', type: 'string', value: config.targetId },
      { name: '时间戳', type: 'number', value: 0 },
  ...
  var deleteRemoteMessages = {
    ...
    desc: '按消息删除指定历史消息',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/group/msgmanage/delete/web#deletebyid',
    params: [
  ...
  var clearHistoryMessages = {
    ...
    desc: '按时间删除历史消息',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/group/msgmanage/delete/web#delete',
    params: [
  ...
  var sendTextMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgsend/web#TxtMsg',
    params: [
  ...
  var sendImageMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgsend/web#ImgMsg',
    params: [
  ...
  var sendFileMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgsend/web#FileMsg',
    params: [
  ...
  var sendVoiceMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgsend/web#HQVCMsg',
    params: [
  ...
  var sendRecallMessage = {
    ...
    desc: '发送撤回消息',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgrecall/web',
    params: [
      { name: '消息 Uid', type: 'string', value: '', event: Service.getLastCacheMsgUId },
      { name: '发送时间', type: 'number', value: 0, event: Service.getLastCacheMsgSentTime },
      { name: '会话类型', type: 'number', value: 1 },
  ...
  var sendAtMessage = {
    ...
    eventName: 'sendMessage',
    desc: '发送 @ 消息',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/group/msgmanage/msgsend/web#at',
    params: [
  ...
  var sendRegisterMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgsend/web#send',
    params: [
      { name: '消息类型', type: 'string', value: 'PersonMessage' },
      { name: '属性值', type: 'string', value: '{"name":"kris","age":29}' },
      { name: '会话类型', type: 'number', value: 1 },
      { name: '对方 id', type: 'string', value: config.targetId },
      { name: '静默消息', type: 'boolean', value: false }
    ]
  ...
  var sendLocationMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgsend/web#LBSMsg',
    params: [
  ...
  var sendRichContentMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgsend/web#ImgTextMsg',
    params: [
  ...
  var sendTypingStatusMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgsend/web#TypSts',
    params: [
      { name: '会话类型', type: 'number', value: 1 },
      { name: '对方 id', type: 'string', value: config.targetId },
  ...
  var sendReceiptRequestMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/receipt/web',
    params: [
      { name: '会话类型', type: 'number', value: 1 },
      { name: '对方 id', type: 'string', value: config.targetId },
  ...
  var sendSightMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgsend/web#SightMsg',
    params: [
      { name: '会话类型', type: 'number', value: 1 },
      { name: '对方 id', type: 'string', value: config.targetId },
  ...
  var sendReadReceiptRequestMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/group/msgmanage/receipt/web',
    params: [
      { name: '会话类型', type: 'number', value: 3 },
      { name: '对方 id', type: 'string', value: config.targetId },
  ...
  var sendReadReceiptResponseMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/group/msgmanage/receipt/web#RRRspMsg',
    params: [
      { name: '会话类型', type: 'number', value: 3 },
      { name: '对方 id', type: 'string', value: config.targetId },
      { name: '消息 UId', type: 'string', value: '' },
  ...
  var sendSyncReadStatusMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/unreadcount/web#clearUnreadCount',
    params: [
      { name: '会话类型', type: 'number', value: 3 },
  ...
  var getUnreadCount = {
    ...
    desc: '获取指定会话未读数',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/unreadcount/web#one',
    params: [
      { name: '会话类型', type: 'number', value: 1 },
      { name: '对方 id', type: 'string', value: config.targetId },
      { name: 'channelId', type: 'string', value: '' }
  ...
  var joinChatRoom = {
    ...
    desc: '加入指定聊天室, 并拉取消息',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/chatroom/manage/basic/create/serverapi',
    params: [
  ...
  var quitChatRoom = {
    ...
    desc: '退出聊天室',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/chatroom/manage/basic/quit/web',
    params: [
      { name: '聊天室 id', type: 'string', value: config.targetId }
    ]
  };
  ...
  var getChatRoomInfo = {
    ...
    desc: '获取聊天室信息',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/chatroom/manage/basic/info/web',
    params: [
      { name: '聊天室 id', type: 'string', value: config.targetId },
  ...
  var setChatroomEntry = {
    ...
    desc: '设置聊天室自定义属性',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/chatroom/manage/key/set/web',
    params: [
  ...
  var forceSetChatroomEntry = {
    ...
    desc: '强制设置聊天室自定义属性',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/chatroom/manage/key/set/web#force',
    params: [
  ...
  var removeChatroomEntry = {
    ...
    desc: '删除聊天室自定义属性',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/chatroom/manage/key/remove/web',
    params: [
      { name: '属性 key', type: 'string', value: 'chrmKey1' },
      { name: '是否发送消息', type: 'boolean', value: true },
      { name: '附加信息', type: 'string', value: '我是消息中的附加信息' },
  ...
  var forceRemoveChatroomEntry = {
    ...
    desc: '强制删除聊天室自定义属性',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/chatroom/manage/key/remove/web#forcedel',
    params: [
      { name: '属性 key', type: 'string', value: 'chrmKey2' },
      { name: '是否发送消息', type: 'boolean', value: true },
      { name: '附加信息', type: 'string', value: '我是消息中的附加信息' },
  ...
  var getChatroomEntry = {
    ...
    desc: '获取指定聊天室自定义属性',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/chatroom/manage/key/query/web',
    params: [
      { name: '属性 key', type: 'string', value: 'chrmKey1' },
      { name: '聊天室 id', type: 'string', value: config.targetId }
    ]
  ...
  var getAllChatroomEntries = {
    ...
    desc: '获取所有聊天室自定义属性',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/chatroom/manage/key/query/web#getall',
    params: [
      { name: '聊天室 id', type: 'string', value: config.targetId }
    ]
  };
  ...
  var sendChatroomMessage = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/chatroom/msgmanage/msgsend/web#TxtMsg',
    params: [
  ...
  var setConversationStatus = {
    ...
    desc: '设置会话状态',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/notify/web',
    params: [
  ...
  var updateMessageExpansion = {
    ...
    doc:'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgexpansion/web#update_kv',
    desc: '',
    params: [
      { name: '会话类型', type: 'number', value: 1 },
      { name: '对方 id', type: 'string', value: config.targetId },
  ...
  var removeMessageExpansion = {
    ...
    doc:'http://doc.rongcloud.cn/im/Web/2.X/guide/private/msgmanage/msgexpansion/web#remove_kv',
    desc: '',
    params: [
      { name: '会话类型', type: 'number', value: 1 },
      { name: '对方 id', type: 'string', value: config.targetId },
  ...
  var getChatRoomHistoryMessages = {
    ...
    doc:'http://doc.rongcloud.cn/im/Web/2.X/guide/chatroom/msgmanage/storage/web',
    desc: '',
    params: [
      { name: '聊天室 ID', type: 'string', value: config.targetId },
  ...
  var setDraft = {
    ...
    eventName: 'setDraft',
    desc: '设置会话草稿',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/draft/web#save',
    params: [
      { name: '会话类型', type: 'number', value: 1 },
      { name: '对方 id', type: 'string', value: config.targetId },
  ...
  var getDraft = {
    ...
    eventName: 'setDraft',
    desc: '获取会话草稿',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/draft/web',
    params: [
      { name: '会话类型', type: 'number', value: 1 },
      { name: '对方 id', type: 'string', value: config.targetId },
  ...
  var deleteDraft = {
    ...
    desc: '清除会话草稿',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/draft/web#remove',
    params: [
      { name: '会话类型', type: 'number', value: 1 },
      { name: '对方 id', type: 'string', value: config.targetId },
      { name: 'channelId', type: 'string', value: '' }
  ...
  var getConversationUnreadCount = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/unreadcount/web#multi',
    params: [
  ...
  var clearConversations = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/clear/web#multi',
    params: [
      { name: '会话类型', type: 'string', value: '1,3' }
    ]
  };
  ...
  var clearTotalUnreadCount = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/unreadcount/web#clear',
    params: [
  ...
  var createTag = {
    ...
    eventName: 'createTag',
    desc: '创建标签',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/tag/web#addtag',
    params: [
  ...
  var updateTag = {
    ...
    eventName: 'updateTag',
    desc: '修改标签',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/tag/web#updatetag',
    params: [
      { name: '标签id', type: 'string', value: 'tag_id_001'},
  ...
  var removeTag = {
    ...
    eventName: 'removeTag',
    desc: '删除标签',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/tag/web#removetag',
    params: [
      { name: '标签id', type: 'string', value: 'tag_id_001'},
    ]
  }
  ...
  var getTagList = {
    ...
    desc: '获取标签列表',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/tag/web#taglist',
    params: []
  }
  ...
  var addTagForConversations = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/tag/web#addcontag',
    params: [
      { name: '标签id', type: 'string', value: 'tag_id_001'},
  ...
  var removeTagForConversations = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/tag/web#removecons',
    params: [
      { name: '标签id', type: 'string', value: 'tag_id_001'},
      { name: '会话id', type: 'string', value: config.targetId},
      { name: '会话类型', type: 'number', value: 1},
  ...
  var removeTagsForConversation = {
    ...
    desc: '从单一会话中批量删除标签',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/tag/web#removecontags',
    params: [
  ...
  var getConversationListByTag = {
    ...
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/tag/web#getPagecon',
    params: [
      { name: '标签id', type: 'string', value: 'tag_id_001'},
  ...
  var getUnreadCountByTag = {
    ...
    desc: '根据标签获取未读消息数',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/tag/web#contagUnread',
    params: [
      { name: '标签id', type: 'string', value: 'tag_id_001'},
  ...
  var setConversationStatusInTag = {
    ...
    desc: '设置标签中会话置顶',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/tag/web#setcontagtop',
    params: [
      { name: '标签id', type: 'string', value: 'tag_id_001'},
      { name: '会话id', type: 'string', value: config.targetId},
      { name: '会话类型', type: 'number', value: 1},
  ...
  var getTagsForConversation = {
    ...
    desc: '获取会话下的标签',
    doc: 'http://doc.rongcloud.cn/im/Web/2.X/guide/private/conversation/tag/web#getcontag',
    params: [
      { name: '会话id', type: 'string', value: config.targetId},
      { name: '会话类型', type: 'number', value: 1},
      { name: 'channelId', type: 'string', value: ''},
  ...
  var DefailtReadyApiQueue = [
    ...
    [getConversationList, removeConversation, getConversation, getUnreadCount, getTotalUnreadCount, clearUnreadCount, setConversationStatus, setDraft, getDraft, deleteDraft],
    [getConversationUnreadCount, clearTotalUnreadCount, sendSyncReadStatusMessage],
    ...
    [setChatRoomEntries, removeChatRoomEntries],
