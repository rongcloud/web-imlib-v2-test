(function (win) {
  ...
  function init(config, watcher) {
    ...
    return utils.defered(function (resolve, reject) {
      ...
      RongIMClient.setChatRoomStatusListener && RongIMClient.setChatRoomStatusListener({
        onChanged: watcher.watchChatRoom
      })
      RongIMClient.setMessageBlockedListener && RongIMClient.setMessageBlockedListener({
        onReceived: watcher.watchBlockedMessage
      })
 ...
 */
  ...
  */
  ...
  function setChatRoomEntries(chatRoomId, entries, isAutoDelete, extra) {
    ...
    return utils.defered(function (resolve, reject) {
      RongIMClient.getInstance().setChatRoomEntries(chatRoomId, options, {
        onSuccess: resolve,
        onError: reject
      })
    })
  ...
  function removeChatRoomEntries(chatRoomId, entries, extra) {
    ...
    return utils.defered(function (resolve, reject) {
      RongIMClient.getInstance().removeChatRoomEntries(chatRoomId, {
        entries,
        notificationExtra: extra
      }, {
        onSuccess: resolve,
  ...
  */
  ...
  function setMessageReceivedStatus(messageId, receivedStatus) {
    return new Promise((resolve, reject) => {
      ...
      client.setMessageReceivedStatus(messageId, receivedStatus, callbacks)
    })
  }
